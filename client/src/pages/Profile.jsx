{/*I couldn't make upload profile picture functionality, Cz nowadays firebase storage is not frr even in spark plan*/}
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
     ...
     <form className='flex flex-col gap-4'>
      ...
      <img 
      src={currentUser.profilePic} alt="Profile" 
      className='h-24 w-24 rounded-full self-center cursor-pointer object-cover mt-2'
      onClick={()=>fileRef.current.click()}
      />
      <input 
      defaultValue={currentUser.username} 
      type="text" id='usrename' placeholder='Username' className='bg-slate-100 rounded-lg p-3' 
      />
      <input 
      defaultValue={currentUser.email} 
      type="text" id='email' placeholder='Email' className='bg-slate-100 rounded-lg p-3' 
      />
